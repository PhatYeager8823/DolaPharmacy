...
<div class="floating-contact-wrapper">
    ...
    <div class="contact-options" id="contactOptions">
        {{-- Nút Zalo --}}
        <a href="https://zalo.me/{{ str_replace(['.', ' '], '', $global_setting->zalo ?? '0919795426') }}" target="_blank" class="contact-item zalo" title="Chat Zalo">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Icon_of_Zalo.svg/1200px-Icon_of_Zalo.svg.webp" alt="Zalo">
        </a>

        {{-- Nút Messenger --}}
        <a href="{{ $global_setting->facebook ?? '#' }}" target="_blank" class="contact-item messenger" title="Chat Facebook">
        ...
        {{-- Nút Gọi điện --}}
        <a href="tel:{{ str_replace(['.', ' '], '', $global_setting->hotline ?? '0919795426') }}" class="contact-item phone" title="Gọi ngay">
